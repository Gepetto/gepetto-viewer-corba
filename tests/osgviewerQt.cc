...
{
public:
    ViewerWidget(osg::ArgumentParser& arguments, QWidget* parent = 0, Qt::WindowFlags f = 0, osgViewer::ViewerBase::ThreadingModel threadingModel=osgViewer::CompositeViewer::SingleThreaded) : QWidget(parent, f)
    {
        ...
        QWidget* widget1 = addViewWidget( createGraphicsWindow(0,0,100,100), osgDB::readNodeFiles(arguments) );
...
int main( int argc, char** argv )
{
    ...
    ViewerWidget* viewWidget = new ViewerWidget(arguments, 0, Qt::Widget, threadingModel);
