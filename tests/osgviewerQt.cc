...
class ViewerWidget : public QWidget, public osgViewer::CompositeViewer {
 public:
  ViewerWidget(osg::ArgumentParser& arguments, QWidget* parent = 0,
    ...
    // osgDB::readNodeFile("glider.osgt") ); QWidget* widget3 = addViewWidget(
    ...
    // osgDB::readNodeFile("fountain.osgt") ); QWidget* popupWidget =
    // addViewWidget( createGraphicsWindow(900,100,320,240,"Popup window",true),
    // osgDB::readNodeFile("dumptruck.osgt") ); popupWidget->show();
...
int main(int argc, char** argv) {
  ...
  ViewerWidget* viewWidget =
      new ViewerWidget(arguments, 0, Qt::Widget, threadingModel);
